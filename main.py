...
os.environ["GOOGLE_API_KEY"] = "AIzaSyAG5zse7L99Hq1LiJjJ2LfgOVlkvqY0T0Q"
genai.configure(api_key=os.environ["GOOGLE_API_KEY"])

# Initialize the Gemini model
model = genai.GenerativeModel("gemini-2.5-flash") # Use the latest supported model
# OR (If 2.5 is not available and you are sure 1.5 is):
# model = genai.GenerativeModel("gemini-1.aqq5-flash")
